...
//me crea un div del medico para mostrarlo en la lista de listar
function createMed(Pmedico){
// var r =document.createElement("div");
// r.classList.add('row','table-row');
...
barraMedicos.appendChild(divMedico); 
    ...
    //      </div>
    //      <div id="buttons-med">
    //         <button type="button" id="btn-accept-med" class="btn btn-success rounded-circle d-block"><i class="fa-solid fa-check"></i></button>
    //         <button type="button" id="btn-reject-med" class="btn btn-danger rounded-circle d-block"><i class="fa-solid fa-x"></i></button>
    //      </div>
    //  </div>
    //       `;
}
...
function actionAcceptMed(event){
    ...
    let idMedico = $(this).parent().parent().attr('data-cedula');
